    ...
    <x-slot:button>
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"
            :class="{
                ...
                'text-success-400': table.columnsAreToggled,
            }">
        ...
        <ul class="divide-y divide-gray-200">
            @foreach($table->columns() as $column)
                ...
                <li class="py-2 flex items-center justify-between">
                    ...
                    <button
                        type="button"
                        class="ml-4 relative inline-flex flex-shrink-0 h-6 w-11 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-light-primary-500"
                        :class="{
                            'bg-success-500': table.columnIsVisible(@js($column->key)),
