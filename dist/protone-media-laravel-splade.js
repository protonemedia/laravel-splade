  ...
  return N(() => a.value = !0), Pe(() => a.value = !1), N(() => {
    bt([t, r, n], (s, o) => {
      ...
      !l || Yl(() => {
        ...
        h ? Qe(h) : Ft(l, $e.First | $e.NoScroll) === Bi.Error && console.warn("There are no focusable elements inside the <FocusTrap />"), i.value = (c = e.value) == null ? void 0 : c.activeElement;
      });
