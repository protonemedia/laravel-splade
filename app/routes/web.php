...
Route::middleware('splade')->group(function () {
    ...
    Route::get('toast/infoRightCenter', [ToastController::class, 'infoRightCenter'])->name('toast.infoRightCenter');
    Route::get('toast/infoCenter', [ToastController::class, 'infoCenter'])->name('toast.infoCenter');
    Route::get('toast/infoLeftBottom', [ToastController::class, 'infoLeftBottom'])->name('toast.infoLeftBottom');
    Route::get('toast/successLeftTop', [ToastController::class, 'successLeftTop'])->name('toast.successLeftTop');
    Route::get('toast/successCenterTop', [ToastController::class, 'successCenterTop'])->name('toast.successCenterTop');
    Route::get('toast/successRightTop', [ToastController::class, 'successRightTop'])->name('toast.successRightTop');
    Route::get('toast/successLeftCenter', [ToastController::class, 'successLeftCenter'])->name('toast.successLeftCenter');
    Route::get('toast/successRightCenter', [ToastController::class, 'successRightCenter'])->name('toast.successRightCenter');
    Route::get('toast/successLeftBottom', [ToastController::class, 'successLeftBottom'])->name('toast.successLeftBottom');
    Route::get('toast/successCenterBottom', [ToastController::class, 'successCenterBottom'])->name('toast.successCenterBottom');
    Route::get('toast/successRightBottom', [ToastController::class, 'successRightBottom'])->name('toast.successRightBottom');
    Route::get('toast/warningLeftCenter', [ToastController::class, 'warningLeftCenter'])->name('toast.warningLeftCenter');
    Route::get('toast/warningCenterTop', [ToastController::class, 'warningCenterTop'])->name('toast.warningCenterTop');
    Route::get('toast/warningRightTop', [ToastController::class, 'warningRightTop'])->name('toast.warningRightTop');
    Route::get('toast/warningCenter', [ToastController::class, 'warningCenter'])->name('toast.warningCenter');
    Route::get('toast/warningLeftBottom', [ToastController::class, 'warningLeftBottom'])->name('toast.warningLeftBottom');
    Route::get('toast/warningRightBottom', [ToastController::class, 'warningRightBottom'])->name('toast.warningRightBottom');
    Route::get('toast/warningCenterBottom', [ToastController::class, 'warningCenterBottom'])->name('toast.warningCenterBottom');
    Route::get('toast/dangerLeftTop', [ToastController::class, 'dangerLeftTop'])->name('toast.dangerLeftTop');
    Route::get('toast/dangerCenterTop', [ToastController::class, 'dangerCenterTop'])->name('toast.dangerCenterTop');
    Route::get('toast/dangerRightTop', [ToastController::class, 'dangerRightTop'])->name('toast.dangerRightTop');
    Route::get('toast/dangerLeftCenter', [ToastController::class, 'dangerLeftCenter'])->name('toast.dangerLeftCenter');
    Route::get('toast/dangerCenterBottom', [ToastController::class, 'dangerCenterBottom'])->name('toast.dangerCenterBottom');
    Route::get('toast/dangerCenter', [ToastController::class, 'dangerCenter'])->name('toast.dangerCenter');
    Route::get('toast/dangerRightCenter', [ToastController::class, 'dangerRightCenter'])->name('toast.dangerRightCenter');
    Route::get('toast/dangerRightBottom', [ToastController::class, 'dangerRightBottom'])->name('toast.dangerRightBottom');
